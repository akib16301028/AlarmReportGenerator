...
if uploaded_alarm_file:
    df_alarm = pd.read_excel(uploaded_alarm_file)
    st.dataframe(style_dataframe(df_alarm))

if uploaded_offline_file:
    df_offline = pd.read_excel(uploaded_offline_file)
    st.dataframe(style_dataframe(df_offline))
