...
def style_dataframe(df, duration_cols, is_dark_mode):
    ...
    if is_dark_mode:
        ...
        other_bg = '#d3d3d3'      # Very light blue suitable for dark mode
        font_color = 'white'
    else:
        duration_bg = '#EBADAD'  # Very light gray
        other_bg = '#d3d3d3'      # Very light blue
        font_color = 'black'
    ...
    non_duration_cols = [col for col in df_style.columns if col  in ['Cluster', 'Zone'] + duration_cols]
    styler = styler.applymap(
