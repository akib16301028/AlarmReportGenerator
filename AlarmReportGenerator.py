...
def style_dataframe(df, duration_cols, is_dark_mode):
    ...
    if is_dark_mode:
        duration_bg = '#CD9A99'  # Very light gray suitable for dark mode
        other_bg = '#99CBCC'      # Very light blue suitable for dark mode
        font_color = 'white'
    else:
        duration_bg = '#CD9A99'  # Very light gray
        other_bg = '#99CBCC'      # Very light blue
        font_color = 'black'
